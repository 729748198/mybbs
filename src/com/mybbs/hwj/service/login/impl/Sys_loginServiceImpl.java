...
public class Sys_loginServiceImpl implements Sys_loginService {
	...
	public Sys_login selectByUsername(String username) {
		// TODO Auto-generated method stub
		System.out.println("Sys_login selectByUsername(String username)");
	...
	public int InsertBasename(String name,String user) {
		int flag=0;
		System.out.println(name+" "+user);
		String SQL="insert into base_userinfo (base_id,base_name,base_sex,base_age,base_fatieshu,base_huitieshu,base_shenfenzheng,username) values (6,?,男,20,0,0,0,?)";
		flag = jdbcTemplate.update(SQL,name,user);
		return flag;
	}
