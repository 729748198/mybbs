package com.mybbs.hwj.service.forum.impl;
...
import com.mybbs.hwj.dao.forum.forumMainMapper;
...
public class ForumServiceImpl{
	...
	public int insertMain (String main_id,String main_title,String main_flag,String main_type,String main_content,
		...
		String updateBaseUserinfo = "UPDATE base_userinfo SET base_fatieshu = base_fatieshu+1 WHERE username = ?";
		
		updateFlag += jdbcTemplate.update(updateBaseUserinfo,main_creatuser);
	...
	public List<Map<String, Object>> getMainPage(String mainType,Integer start,Integer offset) {
		...
		if (mainType!=null){
			//按类别查看帖子
			selectMainSql = "SELECT main.*,info.info_id,info.info_reply,info.info_see,info.info_lastuser,info.info_lastime FROM mybbs.forum_main as main left join forum_info as info on main.main_id = info.main_id where main.main_type = ? order by main.main_recommend,main.main_creatime desc limit ?,?";
			...
			//查看精华帖子
			selectMainSql = "SELECT main.*,info.info_id,info.info_reply,info.info_see,info.info_lastuser,info.info_lastime FROM mybbs.forum_main as main left join forum_info as info on main.main_id = info.main_id where main.main_recommend = 1 order by main.main_recommend,main.main_creatime desc limit ?,?";
	...
	public List<Map<String,Object>> getMainByTitle(String mainTitle){
		String selectMainSql = "SELECT main.*,info.info_id,info.info_reply,info.info_see,info.info_lastuser,info.info_lastime FROM mybbs.forum_main as main left join forum_info as info on main.main_id = info.main_id where main.main_title like ? order by main.main_recommend,main.main_creatime desc";
	...
	public List<Map<String, Object>> getBanzhu(String mainType) {
		String selectBanzhuByMainTypeSql = "SELECT * FROM mybbs.forum_banzhu where main_type = ?";
