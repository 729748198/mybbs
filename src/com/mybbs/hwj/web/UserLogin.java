...
import com.mybbs.hwj.service.login.Sys_loginService;
import com.mybbs.hwj.service.login.impl.Sys_loginServiceImpl;
import com.mybbs.hwj.service.role.Sys_roleService;
import com.mybbs.hwj.standard.Util;
import com.mybbs.hwj.util.MD5;
import com.mybbs.hwj.utils.ValidataUtil;
import com.mybbs.hwj.utils.VerifyCodeUtil;
...
public class UserLogin {
  ...
  //这里是给个人信息界面设置默认值，否则发帖数回帖数不能计算。留坑以后填
    				Base_info base_info=new Base_info();
    				base_info.setUsername(username);
    				base_info.setName(wxname);
    				base_info.setAge(20);
    				base_info.setFatieshu(0);
    				base_info.setSex("男");
    				base_info.setHuitieshu(0);
    				base_info.setShenfenzheng("0");
    				infoService.insertSelective(base_info);
